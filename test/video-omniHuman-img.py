...
def main():
    parser = argparse.ArgumentParser(description="OmniHuman-1.5 视频生成与状态查询脚本")
    ...
    payload = {
        ...
        "content": [
            ...
            },
            {
                "type": "image_url",
                "image_url": {
                    "url": "https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_1377552fc27fd6b88428d10de354ed1d.png"
                }
            },
            {
                "type": "audio_url",
                "audio_url": {
                    "url": "https://maas-task.s3.cn-north-1.jdcloud-oss.com/upload/2026-01-05/test_audio.mp3"
                }
            },
            {
                "type": "mask_url",
                "image_url": {
                    "url": "https://maas-task.s3.cn-north-1.jdcloud-oss.com/upload/2026-01-05/test01051343"
                }
            }
        ],
        "parameters": {
    ...
    sys.stdout.write(f"正在向 {submit_url} 提交 OmniHuman 视频生成任务...\n")
