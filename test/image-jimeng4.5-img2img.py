...
def main() -> int:
    ...
    parser.add_argument("--prompt", default="生成狗狗趴在草地上的近景画面")
    ...
    parser.add_argument("--image", default="https://ark-project.tos-cn-beijing.volces.com/doc_image/seedream4_imageToimage.png")
